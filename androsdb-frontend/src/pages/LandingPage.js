        ...
        <div className="landing-container">
            ...
            <div className="landing-top">
                <div className="hero-content">
                    <h1>Explore the Families of Andros over the Years</h1>
            ...
            {/* Bottom Half: Split Sections */}
            <div className="landing-bottom">

                {/* Section 1: Explore (Stacked Vertical Layout) */}
                <div className="explore-vertical-section">
                    <div className="section-header">
                        <h2>Explore</h2>
                        <p>Browse People, Events, Places, and Sources</p>
                    </div>
            ...
            {/* Section 2: Visualize Map Band (Lighter Blue) */}
